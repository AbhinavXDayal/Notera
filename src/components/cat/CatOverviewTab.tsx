        ...
        <div className="rounded-2xl bg-surface-container border border-outline-variant p-6 sm:p-7 shadow-terra-card space-y-8">
          ...
          <div className="flex items-center justify-between">
            ...
            <button
              type="button"
              onClick={toggleAll}
              className="text-xs font-mono text-primary hover:text-on-surface border border-outline-variant/80 hover:border-primary px-3 py-1.5 rounded-lg bg-surface/60 transition-all cursor-pointer"
            >
...
ACCURACY → What causes my mistakes?`}
          ...
          <div className="space-y-3 pt-1">
            ...
            {openSections["summary"] && (
              <div className="grid grid-cols-1 sm:grid-cols-2 gap-1.5 text-xs font-mono text-secondary pt-1 fade-in">
                {[
